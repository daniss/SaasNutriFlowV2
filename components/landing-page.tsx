              ...
              <div className="px-2 pt-2 pb-3 space-y-1">
                ...
                {isAuthenticated ? (
                  <>
                    ...
                    <button
                      onClick={handleSignOut}
                      className="flex items-center px-3 py-2 text-red-600 hover:text-red-700 transition-colors w-full text-left"
                    >
                      <LogOut className="h-4 w-4 mr-2" />
                      Se déconnecter
                    </button>
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl text-gray-600 leading-relaxed">
                  Votre assistant numérique tout-en-un pour diététiciens.
                  Optimisez la gestion de vos clients, générez des plans
                  alimentaires alimentés par l'IA, et automatisez votre pratique
                  — le tout dans une seule belle plateforme.
                </p>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-4 mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900">
              Tout ce dont vous avez besoin pour gérer votre pratique
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              De la gestion des clients à la planification de repas alimentée
              par l'IA, NutriFlow fournit tous les outils dont vous avez besoin
              pour offrir des soins exceptionnels tout en économisant du temps.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 group">
              <CardContent className="p-8 text-center space-y-4">
                ...
                <p className="text-gray-600">
                  Organisez, étiquetez et suivez facilement les progrès de vos
                  clients avec notre tableau de bord intuitif et des profils
                  détaillés.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 group">
              <CardContent className="p-8 text-center space-y-4">
                ...
                <p className="text-gray-600">
                  Générez instantanément des plans alimentaires personnalisés
                  grâce à notre IA avancée qui prend en compte les restrictions
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 group">
              <CardContent className="p-8 text-center space-y-4">
                ...
                <p className="text-gray-600">
                  Ne manquez jamais un suivi ou un rendez-vous avec des
                  notifications intelligentes par email, SMS et WhatsApp.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 group">
              <CardContent className="p-8 text-center space-y-4">
                ...
                <p className="text-gray-600">
                  Gérez la facturation sans effort avec la facturation
                  automatique, le suivi des paiements et les rapports
                  financiers.
                </p>
              </CardContent>
            </Card>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-4 mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Configurer votre cabinet de nutrition numérique n'a jamais été
              aussi simple. Suivez ces étapes pour transformer votre flux de
              travail.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
            <div className="text-center space-y-6">
              ...
              <div className="space-y-2">
                <h3 className="text-xl font-semibold text-gray-900">
                  Inscrivez-vous et personnalisez
                </h3>
                <p className="text-gray-600">
                  Créez votre compte et personnalisez votre portail client avec
                  votre image de marque, vos couleurs et votre message de
                  bienvenue.
                </p>
              </div>
            </div>
            ...
            <div className="text-center space-y-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-gray-600">
                  Ajoutez vos clients, suivez leurs progrès et générez des plans
                  alimentaires personnalisés grâce à notre assistant IA.
                </p>
              </div>
            </div>
            ...
            <div className="text-center space-y-6">
              ...
              <div className="space-y-2">
                <h3 className="text-xl font-semibold text-gray-900">
                  Automatisez et suivez
                </h3>
                <p className="text-gray-600">
                  Configurez des rappels automatiques, suivez les paiements et
                  regardez votre cabinet fonctionner en toute fluidité sur
                  pilote automatique.
                </p>
              </div>
            </div>
      ...
      <section className="py-20 bg-gradient-to-br from-emerald-50 to-teal-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-4 mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900">
              Adopté par les diététiciens du monde entier
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Découvrez comment NutriFlow transforme les cabinets de nutrition
              et aide les diététiciens à offrir de meilleurs soins.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="border-0 shadow-lg">
              <CardContent className="p-8 space-y-6">
                ...
                <p className="text-gray-700 italic">
                  "Si NutriFlow tient ses promesses, ça va vraiment me faire
                  gagner du temps sur les suivis. L'idée d'automatiser les plans
                  tout en gardant le côté humain, c'est exactement ce qu'il me
                  fallait."
                </p>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-emerald-600 mt-1">
                      Inscrite sur la liste d'accès anticipé • Cabinet de 45
                      clients
                    </p>
                  </div>
                </div>
            ...
            <Card className="border-0 shadow-lg">
              <CardContent className="p-8 space-y-6">
                ...
                <p className="text-gray-700 italic">
                  "Si NutriFlow tient ses promesses, ça va vraiment m'aider au
                  quotidien. J'ai hâte de pouvoir passer moins de temps sur
                  l'administratif et plus avec mes patients."
                </p>
                <div className="flex items-center gap-3">
            ...
            <Card className="border-0 shadow-lg">
              <CardContent className="p-8 space-y-6">
                ...
                <p className="text-gray-700 italic">
                  "Après avoir vu la démo, j'ai hâte de tester l'intégration
                  avec les applis de sport ! Mes athlètes pourraient enfin avoir
                  une approche vraiment personnalisée en fonction de leur
                  activité."
                </p>
                <div className="flex items-center gap-3">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Découvrez toute la puissance de NutriFlow avec notre essai
                gratuit de 14 jours. Aucune carte de crédit requise, pas de
                frais d'installation, annulation à tout moment.
              </p>
            </div>
              ...
              <CardContent className="p-12 space-y-8">
                <div className="space-y-4">
                  ...
                  <h3 className="text-2xl font-bold text-gray-900">
                    Testez tout, sans risque
                  </h3>
                  <p className="text-gray-600 max-w-md mx-auto">
                    Accédez à toutes les fonctionnalités incluant la
                    planification de repas IA, la gestion des clients, les
                    rappels automatisés et la facturation.
                  </p>
                </div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="space-y-4">
              ...
              <p className="text-gray-400">
                Donner aux diététiciens les outils IA pour offrir des soins
                clients exceptionnels et développer leur cabinet.
              </p>
            </div>
